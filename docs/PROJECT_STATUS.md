...
- Audit correction: `SF-CORRECTION-001` through `007` close the data-loss, recovery, filesystem-identity, lifecycle-race, schema/migration, macOS file-access, traceability, headless dependency, and per-window ownership boundaries.
...
- Verification: `./sf verify` passed on 2026-07-19 with 136 unit tests and 16 UI tests after `SF-CORRECTION-007`.
- Next READY item: `SF-CORRECTION-008`, residual accessibility, identity, scanning, asset-capacity, and fixture-hygiene corrections.
