...
- Package v1 remains securely bounded to 8 MiB total and 4 MiB per member. It cannot represent the specification's 500-asset fixture; no limit was relaxed for a benchmark. Resource representation and the full measurement matrix belong to `SF-AUTHORING-000` and a later versioned persistence decision.
